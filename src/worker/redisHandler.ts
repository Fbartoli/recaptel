import { getSubscriber, type AuthCommand, publishAuthState } from "./redis.js";
...
export class RedisHandler {
  ...
  async start(): Promise<void> {
    ...
    await this.subscriber.psubscribe("telegram:auth:*");
    ...
    console.log("[Redis] Handler started (listening to all auth channels)");
  }
  ...
  async stop(): Promise<void> {
    await this.subscriber.punsubscribe("telegram:auth:*");
